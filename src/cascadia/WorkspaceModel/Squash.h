...
// new snapshot one extra time -- benign because mutators are idempotent
...
// this slice; this header only provides the operation itself. The cutover
// slice wires the trigger.
//
